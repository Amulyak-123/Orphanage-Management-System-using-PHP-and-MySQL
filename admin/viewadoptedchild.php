...
adoptedchild.pin,children.Image,adoptedchild.guardianname,adoptedchild.dateofadoption from adoptedchild inner join application on application.appid=adoptedchild.appid inner join children on children.childid=adoptedchild.childid;");
$stmt->execute();
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    array_push($dateofadoption,$row["dateofadoption"]);
