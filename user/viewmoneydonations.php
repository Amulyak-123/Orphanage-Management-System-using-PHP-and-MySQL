...
$stmt=$conn->prepare("select firstname,email,moneydonations.userid,donationid,amount,donateddate,transfertype,image,phonenumber from moneydonations inner join user on user.userid=moneydonations.userid where email=?;");
